...
import 'package:japanesefoodappp/providers/cart.dart';
import 'package:japanesefoodappp/providers/order_model.dart';
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      Firestore.instance
                          .collection('orders')
                          .document(widget.orderSnapshot.documentID)
                          .updateData({'status': 'completed'}).then((value) {
                        Navigator.pop(context);
                      });
